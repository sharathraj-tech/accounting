            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal m-t-30" method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" id="bdate" name="expense_date" class="form-control mydatepicker" placeholder="Select Date" required="">
                                        </div>
                                    </div>
                                    <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" name="account" required>
                                                ...
                                                <?php 
                                                $fetch_accounts=mysqli_query($con, "SELECT ac_id,ac_name from chart_of_accounts WHERE ac_group_id = 2") or die(mysqli_error($con));
                                    ...
                                    <button type="submit" class="btn btn-info waves-effect waves-light m-r-10" name="add_expense">Submit</button>
                    ...
                    <?php 
                    	...
                    	{
                    		$date=mysqli_real_escape_string($con,$_POST['expense_date']);
							...
							$date = date('Y-m-d', strtotime(str_replace('-', '/', $date)));
             				$expense_add=mysqli_query($con,"INSERT INTO expense(ac_id,particulars,amount,date_of_entry) VALUES($ac_type,'$narration',$amount,'$date')") or die(mysqli_error($con));
             				if($expense_add)
             				{
					...
					<div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">Expense Table</h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        	<?php 
                                        	$icn=mysqli_query($con,"SELECT a.*,i.* FROM expense i INNER JOIN chart_of_accounts a ON a.ac_id = i.ac_id WHERE a.ac_group_id=2") or die(mysqli_error($con));

                                        	 	if(mysqli_num_rows($icn)){
                                        	 	while($expense_retrieve=mysqli_fetch_array($icn)){
                                        			?>
                                        	<tr>
                                                <td><?php echo $expense_retrieve['expense_id']; ?></td>
                                                <td><?php echo $expense_retrieve['date_of_entry']; ?></td>
                                                <td><?php echo $expense_retrieve['particulars']; ?></td>
                                                <td><?php echo $expense_retrieve['amount']; ?></td>
                                                <td><?php echo $expense_retrieve['ac_name']; ?></td>
                                            </tr>
                                        			<?php
                                        		}
                                        	}
                                        ...
                                        <tfoot>
                                        	<tr>
                                        		<?php $total_expense=mysqli_fetch_array(mysqli_query($con,"SELECT SUM(amount) as sum FROM expense")); ?>
                                        		<th colspan="3">Total</th>
                                        		<th><?php echo $total_expense['sum']; ?></th>
                                        	</tr>
                                        </tfoot>
                                    </table>
                                </div>
