            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <div class="user-pro-body">
                        ...
                        <div class="dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle u-dropdown link hide-menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['admin_name']; ?> <span class="caret"></span></a>
                            <div class="dropdown-menu animated flipInY">
                                ...
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="includes/logout.php" class="dropdown-item"><i class="fas fa-power-off"></i> Logout</a>
                                <!-- text-->
                            </div>
                        </div>
                    </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="waves-effect waves-dark" href="add-income.php" aria-expanded="false">
                                <i class="icon-speedometer"></i>
                                <span class="hide-menu">Add Income</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="add-expense.php" aria-expanded="false">
                                <i class="icon-speedometer"></i>
                                <span class="hide-menu">Add Expense</span>
                            </a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="add_accounts.php" aria-expanded="false">
                                <i class="icon-speedometer"></i>
                                <span class="hide-menu">Add Accounts</span>
                            </a>
                        </li>
						...
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-docs"></i><span class="hide-menu">Reports</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="view-expense.php">View Expense</a></li>
                                <li><a href="view-students.php">View Students</a></li>
                            </ul>
                        </li>
						<!--<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu"></span></a>
                            <ul aria-expanded="false" class="collapse">
